-- =====================================================
-- Arquivo: insert_tupa_etec.sql
-- Descrição: Seed COMPLETO e LIMPO, focado em Tupã/SP (usuários + caronas + interações).
--            Variante do insert_tupa.sql com uma 3ª escola (ETEC) acrescentada ao final
--            — ver o BLOCO ETEC (seções E1-E12). Arquivo único — rodar após create.sql.
--
-- Características:
--   1. IDs sequenciais LIMPOS, sem lacunas.
--   2. SEM contas-placeholder: todo usuário tem usu_nome e usu_endereco.
--   3. 3 instituições REAIS de Tupã (UNESP, UNIFADAP, ETEC) — endereços/CEPs verificados.
...
--   6. 50 usuários, 46 caronas, interações completas (ETEC: +19 usuários, +30 caronas).
--
...
INSERT INTO USUARIOS (usu_nome, usu_telefone, usu_matricula, usu_senha, usu_verificacao, usu_verificacao_expira, usu_status, usu_email, usu_descricao, usu_endereco, usu_endereco_geom, usu_horario_habitual, usu_lat, usu_lon) VALUES
    ...
    ('Administrador UNESP Tupã','14991230002','ADMUNESP01', '$2b$12$IG1G1Al0Qd/ndqaJgrySNOLrLG69gXpaaCdGDsqRrdTf/H3s0UjTO', 1, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'administrador@unesp.br',            'Administrador da UNESP Tupã.',                  'Av. Domingos da Costa Lopes, 780, Jardim Itaipu, Tupã - SP','-21.9281770,-50.4909540', NULL,        -21.9281770, -50.4909540),  -- 2  Admin@123
    ('Administrador UNIFADAP', '14991230003', 'ADMUNI0001', '$2b$12$IG1G1Al0Qd/ndqaJgrySNOLrLG69gXpaaCdGDsqRrdTf/H3s0UjTO', 1, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'administrador@unifadap.edu.br',     'Administrador da UNIFADAP.',                    'Rua Mandaguaris, 1010, Centro, Tupã - SP',                  '-21.9355210,-50.5195600', NULL,        -21.9355210, -50.5195600),  -- 3  Admin@123
...
-- #####################################################################################
-- #  BLOCO ETEC — 3ª instituição (esc_id=3): ETEC Prof. Massuyuki Kawano (Tupã/SP)    #
-- #  Acrescenta usuários e ~30 caronas (23–30/jun/2026, status variados) para a ETEC. #
-- #  Apêndice ao seed Tupã — IDs continuam de onde o bloco anterior parou:            #
-- #    ESCOLAS→3 · CURSOS→7-9 · USUARIOS→32-50 · VEICULOS→13-24 ·                      #
-- #    CURSOS_USUARIOS→29-46 · CARONAS→17-46                                            #
-- #####################################################################################

-- =====================================================
-- E1. ESCOLA ETEC (esc_id=3)
-- =====================================================
INSERT INTO ESCOLAS (esc_nome, esc_endereco, esc_dominio, esc_max_usuarios, esc_lat, esc_lon, esc_contrato_duracao, esc_contrato_inicio, esc_contrato_expira, esc_contrato_arquivo, esc_ocr_base, esc_ocr_keywords) VALUES
    ('ETEC Prof. Massuyuki Kawano', 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP, CEP 17605-440', 'aluno.cps.sp.gov.br', 400, -21.9386200, -50.5269930, '5anos', '2025-01-01', '2030-01-01', NULL, NULL, '["etec","massuyuki","kawano","centro","paula","souza","tecnico","informatica","desenvolvimento","sistemas","internet"]');  -- esc_id=3  (esc_contrato_arquivo=NULL: sem PDF real → botões Visualizar/Download desabilitados, como UNESP/UNIFADAP)


-- =====================================================
-- E2. CURSOS ETEC (cur_id 7-9) — área de Informática
-- =====================================================
INSERT INTO CURSOS (cur_semestre, cur_nome, esc_id) VALUES
    (3, 'Técnico em Desenvolvimento de Sistemas', 3),   -- cur_id=7
    (3, 'Técnico em Informática',                 3),   -- cur_id=8
    (2, 'Técnico em Informática para Internet',   3);   -- cur_id=9


-- =====================================================
-- E3. USUARIOS ETEC (usu_id 32-50)
-- 32 = Admin ETEC | 33-44 = motoristas (com veículo) | 45-50 = passageiros
-- =====================================================
INSERT INTO USUARIOS (usu_nome, usu_telefone, usu_matricula, usu_senha, usu_verificacao, usu_verificacao_expira, usu_status, usu_email, usu_descricao, usu_endereco, usu_endereco_geom, usu_horario_habitual, usu_lat, usu_lon) VALUES
    -- ── Administrador da ETEC ────────────────────────────────────────────────
    ('Administrador ETEC Tupã','14991230032','ADMETEC001', '$2b$12$IG1G1Al0Qd/ndqaJgrySNOLrLG69gXpaaCdGDsqRrdTf/H3s0UjTO', 1, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'gestor.tupa@etec.sp.gov.br', 'Administrador da ETEC Massuyuki Kawano.', 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9375590,-50.5280040', NULL,        -21.9375590, -50.5280040),  -- 32 Admin@123
    -- ── Motoristas ETEC (verif=2) ────────────────────────────────────────────
    ('Pedro Yamamoto',   '14991230033', 'ET2026032', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 2, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'pedro.yamamoto@aluno.cps.sp.gov.br',   'Desenv. de Sistemas, ofereço carona de manhã.',  'Rua Coroados, 140, Centro, Tupã - SP',                 '-21.9326220,-50.5168850', '07:00:00', -21.9326220, -50.5168850),  -- 33 carro
    ('Mariana Okabe',    '14991230034', 'ET2026033', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 2, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'mariana.okabe@aluno.cps.sp.gov.br',    'Informática, saio da Vila Lahoz.',               'Rua Antônio Lahoz, 150, Vila Lahoz, Tupã - SP',        '-21.9327550,-50.5064470', '06:50:00', -21.9327550, -50.5064470),  -- 34 carro
    ('Lucas Tanaka',     '14991230035', 'ET2026034', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 2, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'lucas.tanaka@aluno.cps.sp.gov.br',     'Info p/ Internet, tenho moto e volto à noite.',  'Rua Tapajós, 200, Centro, Tupã - SP',                 '-21.9304920,-50.5232480', '18:20:00', -21.9304920, -50.5232480),  -- 35 moto
    ('Sofia Brandão',    '14991230036', 'ET2026035', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 2, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'sofia.brandao@aluno.cps.sp.gov.br',    'Desenv. de Sistemas, carona pela manhã.',        'Avenida Tapuias, 410, Centro, Tupã - SP',             '-21.9360090,-50.5111610', '07:10:00', -21.9360090, -50.5111610),  -- 36 carro
    ('Henrique Vidal',   '14991230037', 'ET2026036', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 2, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'henrique.vidal@aluno.cps.sp.gov.br',   'Informática, saio do Centro.',                   'Rua Bororós, 300, Centro, Tupã - SP',                 '-21.9339050,-50.5170110', '07:00:00', -21.9339050, -50.5170110),  -- 37 carro
    ('Isabela Nunes',    '14991230038', 'ET2026037', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 2, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'isabela.nunes@aluno.cps.sp.gov.br',    'Info p/ Internet, Jardim Santo Antônio.',        'Rua Rio Claro, 90, Jardim Santo Antônio, Tupã - SP',  '-21.9353330,-50.4968560', '06:55:00', -21.9353330, -50.4968560),  -- 38 carro
    ('Murilo Sato',      '14991230039', 'ET2026038', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 2, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'murilo.sato@aluno.cps.sp.gov.br',      'Desenv. de Sistemas, moto, volto à noite.',      'Avenida Lélio Pizza, 110, Vila Lahoz, Tupã - SP',     '-21.9323200,-50.5070060', '18:10:00', -21.9323200, -50.5070060),  -- 39 moto
    ('Carla Bezerra',    '14991230040', 'ET2026039', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 2, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'carla.bezerra@aluno.cps.sp.gov.br',    'Informática, saio do Centro.',                   'Rua Botocudos, 80, Centro, Tupã - SP',                '-21.9322950,-50.5199380', '07:05:00', -21.9322950, -50.5199380),  -- 40 carro
    ('André Lopes',      '14991230041', 'ET2026040', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 2, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'andre.lopes@aluno.cps.sp.gov.br',      'Info p/ Internet, saio do Centro.',              'Rua Mandaguaris, 500, Centro, Tupã - SP',             '-21.9355210,-50.5195600', '07:15:00', -21.9355210, -50.5195600),  -- 41 carro
    ('Patrícia Maia',    '14991230042', 'ET2026041', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 2, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'patricia.maia@aluno.cps.sp.gov.br',    'Desenv. de Sistemas, saio da Vila Lahoz.',       'Rua Dona Palma, 60, Vila Lahoz, Tupã - SP',           '-21.9339030,-50.5043900', '07:00:00', -21.9339030, -50.5043900),  -- 42 carro
    ('Vitor Hugo',       '14991230043', 'ET2026042', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 2, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'vitor.hugo@aluno.cps.sp.gov.br',       'Informática, moto, volto à noite.',              'Avenida Tamoios, 250, Centro, Tupã - SP',             '-21.9281990,-50.5118790', '18:30:00', -21.9281990, -50.5118790),  -- 43 moto
    ('Renan Aoki',       '14991230044', 'ET2026043', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 2, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'renan.aoki@aluno.cps.sp.gov.br',       'Info p/ Internet, saio do Centro.',              'Rua Coroados, 320, Centro, Tupã - SP',                '-21.9326220,-50.5168850', '07:20:00', -21.9326220, -50.5168850),  -- 44 carro
    -- ── Passageiros ETEC (verif=1) ───────────────────────────────────────────
    ('Júlia Castro',     '14991230045', 'ET2026044', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 1, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'julia.castro@aluno.cps.sp.gov.br',     'Desenv. de Sistemas, busco carona de manhã.',    'Rua Antônio Lahoz, 80, Vila Lahoz, Tupã - SP',        '-21.9327550,-50.5064470', '07:00:00', -21.9327550, -50.5064470),  -- 45 passageiro
    ('Enzo Ferreira',    '14991230046', 'ET2026045', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 1, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'enzo.ferreira@aluno.cps.sp.gov.br',    'Informática, procuro carona pra ETEC.',          'Avenida Lélio Pizza, 200, Vila Lahoz, Tupã - SP',     '-21.9323200,-50.5070060', '07:05:00', -21.9323200, -50.5070060),  -- 46 passageiro
    ('Larissa Yano',     '14991230047', 'ET2026046', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 1, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'larissa.yano@aluno.cps.sp.gov.br',     'Info p/ Internet, carona de manhã.',             'Rua Tapajós, 90, Centro, Tupã - SP',                  '-21.9304920,-50.5232480', '07:10:00', -21.9304920, -50.5232480),  -- 47 passageiro
    ('Gustavo Kimura',   '14991230048', 'ET2026047', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 1, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'gustavo.kimura@aluno.cps.sp.gov.br',   'Desenv. de Sistemas, moro no Centro.',           'Rua Bororós, 150, Centro, Tupã - SP',                 '-21.9339050,-50.5170110', '07:00:00', -21.9339050, -50.5170110),  -- 48 passageiro
    ('Beatriz Sano',     '14991230049', 'ET2026048', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 1, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'beatriz.sano@aluno.cps.sp.gov.br',     'Informática, Jardim Santo Antônio.',             'Rua Rio Claro, 200, Jardim Santo Antônio, Tupã - SP', '-21.9353330,-50.4968560', '07:05:00', -21.9353330, -50.4968560),  -- 49 passageiro
    ('Felipe Tomaz',     '14991230050', 'ET2026049', '$2b$12$Piwxr050DVwdiJv/0.IRZOtoxsLcraeGCp0jN50PMyh0zNa8iptO2', 1, DATE_ADD(NOW(), INTERVAL 6 MONTH), 1, 'felipe.tomaz@aluno.cps.sp.gov.br',     'Info p/ Internet, saio da Vila Lahoz.',          'Rua Dona Palma, 200, Vila Lahoz, Tupã - SP',          '-21.9339030,-50.5043900', '07:15:00', -21.9339030, -50.5043900);  -- 50 passageiro


-- =====================================================
-- E4. USUARIOS_REGISTROS ETEC (usu_id 32-50)
-- =====================================================
INSERT INTO USUARIOS_REGISTROS (usu_id, usu_data_login, usu_criado_em, usu_atualizado_em) VALUES
    (32, NOW(), '2026-01-12 08:00:00', NOW()),
    (33, NOW(), '2026-03-12 08:00:00', NOW()), (34, NOW(), '2026-03-12 08:05:00', NOW()),
    (35, NOW(), '2026-03-13 08:00:00', NOW()), (36, NOW(), '2026-03-13 08:05:00', NOW()),
    (37, NOW(), '2026-03-14 08:00:00', NOW()), (38, NOW(), '2026-03-14 08:05:00', NOW()),
    (39, NOW(), '2026-03-15 08:00:00', NOW()), (40, NOW(), '2026-03-15 08:05:00', NOW()),
    (41, NOW(), '2026-03-16 08:00:00', NOW()), (42, NOW(), '2026-03-16 08:05:00', NOW()),
    (43, NOW(), '2026-03-17 08:00:00', NOW()), (44, NOW(), '2026-03-17 08:05:00', NOW()),
    (45, NOW(), '2026-03-18 08:00:00', NOW()), (46, NOW(), '2026-03-18 08:05:00', NOW()),
    (47, NOW(), '2026-03-19 08:00:00', NOW()), (48, NOW(), '2026-03-19 08:05:00', NOW()),
    (49, NOW(), '2026-03-20 08:00:00', NOW()), (50, NOW(), '2026-03-20 08:05:00', NOW());


-- =====================================================
-- E5. PERFIL ETEC (usu_id 32-50)
-- per_tipo: 1=Admin ETEC(esc 3), demais Usuário(0). Alunos: per_escola_id NULL
-- (vínculo via CURSOS_USUARIOS → CURSOS.esc_id).
-- =====================================================
INSERT INTO PERFIL (usu_id, per_nome, per_data, per_tipo, per_habilitado, per_escola_id, per_push_notif, per_raio_busca) VALUES
    (32, 'Administrador ETEC Tupã', NOW(), 1, 1, 3,    1, 10),
    (33, 'Pedro Yamamoto',   NOW(), 0, 1, NULL, 1,  8), (34, 'Mariana Okabe',  NOW(), 0, 1, NULL, 1, 10),
    (35, 'Lucas Tanaka',     NOW(), 0, 1, NULL, 1,  5), (36, 'Sofia Brandão',  NOW(), 0, 1, NULL, 1,  8),
    (37, 'Henrique Vidal',   NOW(), 0, 1, NULL, 1,  6), (38, 'Isabela Nunes',  NOW(), 0, 1, NULL, 1, 12),
    (39, 'Murilo Sato',      NOW(), 0, 1, NULL, 1,  5), (40, 'Carla Bezerra',  NOW(), 0, 1, NULL, 1,  9),
    (41, 'André Lopes',      NOW(), 0, 1, NULL, 1,  7), (42, 'Patrícia Maia',  NOW(), 0, 1, NULL, 1,  8),
    (43, 'Vitor Hugo',       NOW(), 0, 1, NULL, 1,  5), (44, 'Renan Aoki',     NOW(), 0, 1, NULL, 1, 10),
    (45, 'Júlia Castro',     NOW(), 0, 1, NULL, 1,  8), (46, 'Enzo Ferreira',  NOW(), 0, 1, NULL, 1, 10),
    (47, 'Larissa Yano',     NOW(), 0, 1, NULL, 1,  6), (48, 'Gustavo Kimura', NOW(), 0, 1, NULL, 1,  9),
    (49, 'Beatriz Sano',     NOW(), 0, 1, NULL, 1,  8), (50, 'Felipe Tomaz',   NOW(), 0, 1, NULL, 1,  7);


-- =====================================================
-- E6. VEICULOS ETEC (vei_id 13-24) — donos = motoristas 33-44
-- Placas únicas (prefixo GTE) para não colidir com as do bloco Tupã.
-- =====================================================
INSERT INTO VEICULOS (usu_id, vei_placa, vei_marca_modelo, vei_tipo, vei_cor, vei_vagas, vei_status, vei_criado_em, vei_atualizado_em, vei_apagado_em) VALUES
    (33, 'GTE1A13', 'Chevrolet Onix',  1, 'Branco',   4, 1, '2026-03-12', NULL, NULL),  -- vei_id=13 Pedro
    (34, 'GTE2A14', 'Hyundai HB20',    1, 'Prata',    4, 1, '2026-03-12', NULL, NULL),  -- vei_id=14 Mariana
    (35, 'GTE3A15', 'Honda CG 160',    0, 'Vermelho', 1, 1, '2026-03-13', NULL, NULL),  -- vei_id=15 Lucas (moto)
    (36, 'GTE4A16', 'Fiat Argo',       1, 'Cinza',    4, 1, '2026-03-13', NULL, NULL),  -- vei_id=16 Sofia
    (37, 'GTE5A17', 'Volkswagen Gol',  1, 'Preto',    3, 1, '2026-03-14', NULL, NULL),  -- vei_id=17 Henrique (3 vagas)
    (38, 'GTE6A18', 'Renault Kwid',    1, 'Azul',     3, 1, '2026-03-14', NULL, NULL),  -- vei_id=18 Isabela (3 vagas)
    (39, 'GTE7A19', 'Yamaha Fazer',    0, 'Azul',     1, 1, '2026-03-15', NULL, NULL),  -- vei_id=19 Murilo (moto)
    (40, 'GTE8A20', 'Toyota Etios',    1, 'Branco',   4, 1, '2026-03-15', NULL, NULL),  -- vei_id=20 Carla
    (41, 'GTE9A21', 'Chevrolet Onix',  1, 'Vermelho', 4, 1, '2026-03-16', NULL, NULL),  -- vei_id=21 André
    (42, 'GTE1B22', 'Hyundai HB20',    1, 'Cinza',    4, 1, '2026-03-16', NULL, NULL),  -- vei_id=22 Patrícia
    (43, 'GTE2B23', 'Honda Biz',       0, 'Preto',    1, 1, '2026-03-17', NULL, NULL),  -- vei_id=23 Vitor (moto)
    (44, 'GTE3B24', 'Volkswagen Polo', 1, 'Prata',    4, 1, '2026-03-17', NULL, NULL);  -- vei_id=24 Renan


-- =====================================================
-- E7. CURSOS_USUARIOS ETEC (cur_usu_id 29-46) — matrículas
-- Motoristas 33-44 → cu29-cu40 | Passageiros 45-50 → cu41-cu46
-- =====================================================
INSERT INTO CURSOS_USUARIOS (usu_id, cur_id, cur_usu_dataFinal) VALUES
    (33, 7, '2026-12-31'),  -- cu29 Pedro     → Desenv. Sistemas
    (34, 8, '2026-12-31'),  -- cu30 Mariana   → Informática
    (35, 9, '2026-12-31'),  -- cu31 Lucas     → Info p/ Internet
    (36, 7, '2026-12-31'),  -- cu32 Sofia     → Desenv. Sistemas
    (37, 8, '2026-12-31'),  -- cu33 Henrique  → Informática
    (38, 9, '2026-12-31'),  -- cu34 Isabela   → Info p/ Internet
    (39, 7, '2026-12-31'),  -- cu35 Murilo    → Desenv. Sistemas
    (40, 8, '2026-12-31'),  -- cu36 Carla     → Informática
    (41, 9, '2026-12-31'),  -- cu37 André     → Info p/ Internet
    (42, 7, '2026-12-31'),  -- cu38 Patrícia  → Desenv. Sistemas
    (43, 8, '2026-12-31'),  -- cu39 Vitor     → Informática
    (44, 9, '2026-12-31'),  -- cu40 Renan     → Info p/ Internet
    (45, 7, '2026-12-31'),  -- cu41 Júlia     → Desenv. Sistemas
    (46, 8, '2026-12-31'),  -- cu42 Enzo      → Informática
    (47, 9, '2026-12-31'),  -- cu43 Larissa   → Info p/ Internet
    (48, 7, '2026-12-31'),  -- cu44 Gustavo   → Desenv. Sistemas
    (49, 8, '2026-12-31'),  -- cu45 Beatriz   → Informática
    (50, 9, '2026-12-31');  -- cu46 Felipe    → Info p/ Internet


-- =====================================================
-- E8. CARONAS ETEC (car_id 17-46) — 30 caronas entre 23 e 30/jun/2026
-- Status variados: 1=Aberta, 2=Em espera, 3=Finalizada, 0=Cancelada.
-- (vei_id, cur_usu_id) apontam para o motorista. Motos (vei 15/19/23) = 1 vaga + capacete.
-- car_vagas_dispo das ATIVAS (status 1/2) é recalculado na seção E12.
-- =====================================================
INSERT INTO CARONAS (vei_id, cur_usu_id, car_desc, car_data, car_hor_saida, car_vagas_dispo, car_status, car_capacete, car_alerta_saida_enviado) VALUES
    -- ── 23/jun ──
    (13, 29, 'Centro → ETEC, saída pela manhã',           '2026-06-23', '07:00:00', 0, 3, 0, 0),  -- car17 Pedro    FINALIZADA
    (14, 30, 'Vila Lahoz → ETEC, manhã',                  '2026-06-23', '06:50:00', 0, 3, 0, 0),  -- car18 Mariana  FINALIZADA
    (16, 32, 'Centro → ETEC, manhã',                      '2026-06-23', '07:10:00', 0, 3, 0, 0),  -- car19 Sofia    FINALIZADA
    (15, 31, 'Volta ETEC → Centro (moto, 1 vaga)',        '2026-06-23', '18:20:00', 0, 3, 1, 0),  -- car20 Lucas    FINALIZADA
    -- ── 24/jun ──
    (17, 33, 'Centro → ETEC, manhã',                      '2026-06-24', '07:00:00', 0, 3, 0, 0),  -- car21 Henrique FINALIZADA
    (18, 34, 'Jd. Santo Antônio → ETEC',                  '2026-06-24', '06:55:00', 3, 0, 0, 0),  -- car22 Isabela  CANCELADA
    (20, 36, 'Centro → ETEC, manhã',                      '2026-06-24', '07:05:00', 0, 3, 0, 0),  -- car23 Carla    FINALIZADA
    -- ── 25/jun ──
    (13, 29, 'Centro → ETEC, manhã',                      '2026-06-25', '07:00:00', 0, 3, 0, 0),  -- car24 Pedro    FINALIZADA
    (19, 35, 'Volta ETEC → Centro (moto, 1 vaga)',        '2026-06-25', '18:10:00', 0, 3, 1, 0),  -- car25 Murilo   FINALIZADA
    (21, 37, 'Centro → ETEC, manhã',                      '2026-06-25', '07:15:00', 4, 0, 0, 0),  -- car26 André    CANCELADA
    (14, 30, 'Vila Lahoz → ETEC, manhã',                  '2026-06-25', '06:50:00', 0, 3, 0, 0),  -- car27 Mariana  FINALIZADA
    -- ── 26/jun ──
    (22, 38, 'Centro → ETEC, manhã',                      '2026-06-26', '07:00:00', 0, 3, 0, 0),  -- car28 Patrícia FINALIZADA
    (16, 32, 'Centro → ETEC, manhã',                      '2026-06-26', '07:10:00', 0, 3, 0, 0),  -- car29 Sofia    FINALIZADA
    (24, 40, 'Centro → ETEC, manhã',                      '2026-06-26', '07:20:00', 4, 0, 0, 0),  -- car30 Renan    CANCELADA
    (17, 33, 'Centro → ETEC, manhã',                      '2026-06-26', '07:00:00', 0, 3, 0, 0),  -- car31 Henrique FINALIZADA
    (23, 39, 'Volta ETEC → Centro (moto, 1 vaga)',        '2026-06-26', '18:30:00', 0, 3, 1, 0),  -- car32 Vitor    FINALIZADA
    -- ── 27/jun ──
    (18, 34, 'Jd. Santo Antônio → ETEC',                  '2026-06-27', '06:55:00', 0, 3, 0, 0),  -- car33 Isabela  FINALIZADA
    (20, 36, 'Centro → ETEC, manhã',                      '2026-06-27', '07:05:00', 0, 3, 0, 0),  -- car34 Carla    FINALIZADA
    (13, 29, 'Centro → ETEC, manhã',                      '2026-06-27', '07:00:00', 4, 0, 0, 0),  -- car35 Pedro    CANCELADA
    -- ── 29/jun ── (abertas)
    (21, 37, 'Centro → ETEC, manhã',                      '2026-06-29', '07:15:00', 4, 1, 0, 0),  -- car36 André    ABERTA
    (14, 30, 'Vila Lahoz → ETEC, manhã',                  '2026-06-29', '06:50:00', 4, 1, 0, 0),  -- car37 Mariana  ABERTA
    (16, 32, 'Centro → ETEC, manhã',                      '2026-06-29', '07:10:00', 4, 1, 0, 0),  -- car38 Sofia    ABERTA
    (22, 38, 'Centro → ETEC, manhã',                      '2026-06-29', '07:00:00', 4, 1, 0, 0),  -- car39 Patrícia ABERTA
    (15, 31, 'Volta ETEC → Centro (moto, 1 vaga)',        '2026-06-29', '18:20:00', 1, 1, 1, 0),  -- car40 Lucas    ABERTA
    -- ── 30/jun ── (abertas + em espera = HOJE)
    (17, 33, 'Centro → ETEC, manhã',                      '2026-06-30', '07:00:00', 3, 1, 0, 1),  -- car41 Henrique ABERTA
    (24, 40, 'Centro → ETEC, manhã',                      '2026-06-30', '07:20:00', 4, 1, 0, 1),  -- car42 Renan    ABERTA
    (20, 36, 'Centro → ETEC, manhã',                      '2026-06-30', '07:05:00', 4, 2, 0, 1),  -- car43 Carla    EM ESPERA
    (13, 29, 'Centro → ETEC, manhã',                      '2026-06-30', '07:00:00', 4, 2, 0, 1),  -- car44 Pedro    EM ESPERA
    (18, 34, 'Jd. Santo Antônio → ETEC',                  '2026-06-30', '06:55:00', 3, 2, 0, 1),  -- car45 Isabela  EM ESPERA
    (19, 35, 'Volta ETEC → Centro (moto, 1 vaga)',        '2026-06-30', '18:10:00', 1, 2, 1, 1);  -- car46 Murilo   EM ESPERA


-- =====================================================
-- E9. PONTO_ENCONTROS ETEC — partida (0) + destino (1) por carona
-- Caronas "→ ETEC": destino = ETEC. Caronas "Volta" (motos): destino = Centro.
-- =====================================================
INSERT INTO PONTO_ENCONTROS (car_id, pon_endereco, pon_endereco_geom, pon_lat, pon_lon, pon_tipo, pon_nome, pon_ordem, pon_status) VALUES
    (17, 'Rua Coroados, 140, Centro, Tupã - SP',                       '-21.9326220,-50.5168850', -21.9326220, -50.5168850, 0, 'Rua Coroados, Centro',        1, 1),
    (17, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (18, 'Rua Antônio Lahoz, 150, Vila Lahoz, Tupã - SP',              '-21.9327550,-50.5064470', -21.9327550, -50.5064470, 0, 'Rua Antônio Lahoz, Vila Lahoz',1, 1),
    (18, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (19, 'Avenida Tapuias, 410, Centro, Tupã - SP',                    '-21.9360090,-50.5111610', -21.9360090, -50.5111610, 0, 'Avenida Tapuias, Centro',     1, 1),
    (19, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (20, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 0, 'ETEC Prof. Massuyuki Kawano', 1, 1),
    (20, 'Avenida Tamoios, Centro, Tupã - SP',                         '-21.9281990,-50.5118790', -21.9281990, -50.5118790, 1, 'Avenida Tamoios, Centro',     2, 1),
    (21, 'Rua Bororós, 300, Centro, Tupã - SP',                        '-21.9339050,-50.5170110', -21.9339050, -50.5170110, 0, 'Rua Bororós, Centro',         1, 1),
    (21, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (22, 'Rua Rio Claro, 90, Jardim Santo Antônio, Tupã - SP',         '-21.9353330,-50.4968560', -21.9353330, -50.4968560, 0, 'Rua Rio Claro, Jardim Santo Antônio',1, 1),
    (22, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (23, 'Rua Botocudos, 80, Centro, Tupã - SP',                       '-21.9322950,-50.5199380', -21.9322950, -50.5199380, 0, 'Rua Botocudos, Centro',       1, 1),
    (23, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (24, 'Rua Coroados, 140, Centro, Tupã - SP',                       '-21.9326220,-50.5168850', -21.9326220, -50.5168850, 0, 'Rua Coroados, Centro',        1, 1),
    (24, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (25, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 0, 'ETEC Prof. Massuyuki Kawano', 1, 1),
    (25, 'Avenida Tamoios, Centro, Tupã - SP',                         '-21.9281990,-50.5118790', -21.9281990, -50.5118790, 1, 'Avenida Tamoios, Centro',     2, 1),
    (26, 'Rua Mandaguaris, 500, Centro, Tupã - SP',                    '-21.9355210,-50.5195600', -21.9355210, -50.5195600, 0, 'Rua Mandaguaris, Centro',     1, 1),
    (26, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (27, 'Rua Antônio Lahoz, 150, Vila Lahoz, Tupã - SP',              '-21.9327550,-50.5064470', -21.9327550, -50.5064470, 0, 'Rua Antônio Lahoz, Vila Lahoz',1, 1),
    (27, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (28, 'Rua Dona Palma, 60, Vila Lahoz, Tupã - SP',                  '-21.9339030,-50.5043900', -21.9339030, -50.5043900, 0, 'Rua Dona Palma, Vila Lahoz',  1, 1),
    (28, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (29, 'Avenida Tapuias, 410, Centro, Tupã - SP',                    '-21.9360090,-50.5111610', -21.9360090, -50.5111610, 0, 'Avenida Tapuias, Centro',     1, 1),
    (29, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (30, 'Rua Coroados, 320, Centro, Tupã - SP',                       '-21.9326220,-50.5168850', -21.9326220, -50.5168850, 0, 'Rua Coroados, Centro',        1, 1),
    (30, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (31, 'Rua Bororós, 300, Centro, Tupã - SP',                        '-21.9339050,-50.5170110', -21.9339050, -50.5170110, 0, 'Rua Bororós, Centro',         1, 1),
    (31, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (32, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 0, 'ETEC Prof. Massuyuki Kawano', 1, 1),
    (32, 'Avenida Tamoios, Centro, Tupã - SP',                         '-21.9281990,-50.5118790', -21.9281990, -50.5118790, 1, 'Avenida Tamoios, Centro',     2, 1),
    (33, 'Rua Rio Claro, 90, Jardim Santo Antônio, Tupã - SP',         '-21.9353330,-50.4968560', -21.9353330, -50.4968560, 0, 'Rua Rio Claro, Jardim Santo Antônio',1, 1),
    (33, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (34, 'Rua Botocudos, 80, Centro, Tupã - SP',                       '-21.9322950,-50.5199380', -21.9322950, -50.5199380, 0, 'Rua Botocudos, Centro',       1, 1),
    (34, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (35, 'Rua Coroados, 140, Centro, Tupã - SP',                       '-21.9326220,-50.5168850', -21.9326220, -50.5168850, 0, 'Rua Coroados, Centro',        1, 1),
    (35, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (36, 'Rua Mandaguaris, 500, Centro, Tupã - SP',                    '-21.9355210,-50.5195600', -21.9355210, -50.5195600, 0, 'Rua Mandaguaris, Centro',     1, 1),
    (36, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (37, 'Rua Antônio Lahoz, 150, Vila Lahoz, Tupã - SP',              '-21.9327550,-50.5064470', -21.9327550, -50.5064470, 0, 'Rua Antônio Lahoz, Vila Lahoz',1, 1),
    (37, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (38, 'Avenida Tapuias, 410, Centro, Tupã - SP',                    '-21.9360090,-50.5111610', -21.9360090, -50.5111610, 0, 'Avenida Tapuias, Centro',     1, 1),
    (38, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (39, 'Rua Dona Palma, 60, Vila Lahoz, Tupã - SP',                  '-21.9339030,-50.5043900', -21.9339030, -50.5043900, 0, 'Rua Dona Palma, Vila Lahoz',  1, 1),
    (39, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (40, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 0, 'ETEC Prof. Massuyuki Kawano', 1, 1),
    (40, 'Avenida Tamoios, Centro, Tupã - SP',                         '-21.9281990,-50.5118790', -21.9281990, -50.5118790, 1, 'Avenida Tamoios, Centro',     2, 1),
    (41, 'Rua Bororós, 300, Centro, Tupã - SP',                        '-21.9339050,-50.5170110', -21.9339050, -50.5170110, 0, 'Rua Bororós, Centro',         1, 1),
    (41, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (42, 'Rua Coroados, 320, Centro, Tupã - SP',                       '-21.9326220,-50.5168850', -21.9326220, -50.5168850, 0, 'Rua Coroados, Centro',        1, 1),
    (42, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (43, 'Rua Botocudos, 80, Centro, Tupã - SP',                       '-21.9322950,-50.5199380', -21.9322950, -50.5199380, 0, 'Rua Botocudos, Centro',       1, 1),
    (43, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (44, 'Rua Coroados, 140, Centro, Tupã - SP',                       '-21.9326220,-50.5168850', -21.9326220, -50.5168850, 0, 'Rua Coroados, Centro',        1, 1),
    (44, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (45, 'Rua Rio Claro, 90, Jardim Santo Antônio, Tupã - SP',         '-21.9353330,-50.4968560', -21.9353330, -50.4968560, 0, 'Rua Rio Claro, Jardim Santo Antônio',1, 1),
    (45, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 1, 'ETEC Prof. Massuyuki Kawano', 2, 1),
    (46, 'Rua Bezerra de Menezes, 215, Vila Independência, Tupã - SP', '-21.9386200,-50.5269930', -21.9386200, -50.5269930, 0, 'ETEC Prof. Massuyuki Kawano', 1, 1),
    (46, 'Avenida Tamoios, Centro, Tupã - SP',                         '-21.9281990,-50.5118790', -21.9281990, -50.5118790, 1, 'Avenida Tamoios, Centro',     2, 1);


-- =====================================================
-- E10. SOLICITACOES_CARONA ETEC — passageiros nas caronas ATIVAS
-- =====================================================
INSERT INTO SOLICITACOES_CARONA (usu_id_passageiro, car_id, sol_status, sol_vaga_soli) VALUES
    (45, 36, 2, 1), (46, 36, 2, 1),   -- car36 (aberta): Júlia, Enzo aceitos
    (47, 37, 2, 1),                    -- car37 (aberta): Larissa aceita
    (48, 39, 2, 1),                    -- car39 (aberta): Gustavo aceito
    (49, 41, 2, 1),                    -- car41 (aberta): Beatriz aceita
    (50, 43, 2, 1),                    -- car43 (em espera): Felipe aceito
    -- Pendentes (sol=1)
    (45, 42, 1, 1),                    -- Júlia → car42 pendente
    (46, 44, 1, 1);                    -- Enzo  → car44 pendente


-- =====================================================
-- E11. CARONA_PESSOAS ETEC — passageiros confirmados (espelha os sol=2)
-- =====================================================
INSERT INTO CARONA_PESSOAS (car_id, usu_id, car_pes_data, car_pes_status) VALUES
    (36, 45, NOW(), 1), (36, 46, NOW(), 1),   -- car36: Júlia, Enzo
    (37, 47, NOW(), 1),                        -- car37: Larissa
    (39, 48, NOW(), 1),                        -- car39: Gustavo
    (41, 49, NOW(), 1),                        -- car41: Beatriz
    (43, 50, NOW(), 1);                        -- car43: Felipe


-- =====================================================
-- E12. RECALCULA car_vagas_dispo das caronas ATIVAS (Tupã + ETEC) = capacidade − aceitos
-- =====================================================
UPDATE CARONAS c
JOIN VEICULOS v ON v.vei_id = c.vei_id
SET c.car_vagas_dispo = v.vei_vagas - (
...
-- =====================================================
-- E13. DENUNCIAS ETEC — relatadas no app (moderadas pelo Admin ETEC / Dev no painel)
-- den_tipo:   0=Denúncia de carona (usa car_id)  1=Denúncia de usuário (usa den_usu_alvo)
-- den_status: 0=Fechado(Resolvido)  1=Aberto(Pendente)  2=Arquivado  3=Em análise
-- den_id_resposta = usu_id de quem respondeu (Admin ETEC=32).
-- Denunciantes e alvos são da ETEC → entram no escopo do Admin ETEC (esc_id=3).
-- =====================================================
INSERT INTO DENUNCIAS (usu_id, den_tipo, car_id, den_usu_alvo, den_motivo, den_texto, den_data, den_status, den_id_resposta, den_resposta) VALUES
    (45, 1, NULL, 35, 'Atraso recorrente',            'O motorista costuma atrasar bastante e avisa em cima da hora.',               DATE_SUB(NOW(), INTERVAL 3 DAY), 3, NULL, NULL),                                              -- Júlia → Lucas (usuário, EM ANÁLISE)
    (46, 0, 32,   NULL, 'Comportamento inadequado',   'O motorista foi ríspido com os passageiros durante a viagem.',               DATE_SUB(NOW(), INTERVAL 4 DAY), 1, NULL, NULL),                                              -- Enzo → carona car32 (carona, ABERTA)
    (48, 1, NULL, 39, 'Direção perigosa',             'Dirigiu acima do limite e freava bruscamente; me senti inseguro.',           DATE_SUB(NOW(), INTERVAL 5 DAY), 0, 32, 'Conversamos com o motorista e a situação foi resolvida. Obrigado pelo aviso.'),  -- Gustavo → Murilo (usuário, RESOLVIDA pelo Admin)
    (47, 1, NULL, 33, 'Cancelamento em cima da hora',  'Cancelou a carona poucos minutos antes da saída, sem aviso prévio.',          DATE_SUB(NOW(), INTERVAL 2 DAY), 3, NULL, NULL),                                              -- Larissa → Pedro (usuário, EM ANÁLISE)
    (49, 0, 25,   NULL, 'Cobrança indevida',          'O motorista pediu um valor além do que havia sido combinado para a carona.', DATE_SUB(NOW(), INTERVAL 4 DAY), 2, 32, 'Após análise, não houve provas suficientes. Denúncia arquivada.');               -- Beatriz → carona car25 (carona, ARQUIVADA)


SET FOREIGN_KEY_CHECKS = 1;

-- =====================================================
-- FIM DO SEED Tupã/SP + ETEC
--   Escolas: 3 (UNESP, UNIFADAP, ETEC) · Usuários: 50 (31 Tupã + 19 ETEC)
--   Caronas: 46 (16 Tupã + 30 ETEC, estas entre 23 e 30/jun/2026, status variados)
--   Denúncias ETEC: 5 (E13) — status variados (aberta, em análise, resolvida, arquivada)
-- =====================================================
