      ...
      <div className={styles.formCard}>
        ...
        <div className={styles.stepIndicator}>
          ...
          <div className={`${styles.stepItem} ${step >= 2 ? styles.stepActive : ''}`}>
            ...
            <span className={styles.stepLabel}>Administrador Responsável</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {step === 1 && (
            <>
              ...
              {stepError && (
                <p className={styles.inlineError} style={{ marginTop: 16 }}>{stepError}</p>
              )}
          ...
          {/* Etapa 2: Administrador Responsável */}
          {step === 2 && (
            <>
              <div className={styles.sectionHeader}>
                <UserPlus size={18} />
