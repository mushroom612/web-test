 ...
 * DESCRIÇÃO: Dados mockados (pré-definidos) para o painel administrativo
 *
 * Este arquivo contém dados de exemplo usados quando a API não está disponível
 * ou como fallback em caso de erro.
 *
 * Dados inclusos:
 * - adminUser: dados do usuário admin logado
 * - metricsData: métricas para o dashboard
 * - feedbacksData: lista de sugestões e denúncias
 * - usersData: lista de usuários
 * - apiRidesData: lista de caronas
 * - apiSuggestionsData: sugestões detalhadas
 * - notificationData: notificações
 * - chartData: dados para gráficos
 *
 * Como usa:
 * 1. No Dashboard: if (error) usa metricsData
 * 2. Em listas: if (API fails) usa usersData, apiRidesData, etc
 * 3. Serves também como modelo de estrutura esperada pela API
 *
 * Interligação:
 * - Importados em: Dashboard.jsx, Usuarios.jsx, Caronas.jsx, etc
 * - Usados como fallback quando api.js falha
 * ============================================================================
 */

// Dados do usuário admin (usado em Aside, Topbar e Dashboard)
export const adminUser = {
  id: 6,
  name: "Admin Sistema",
  email: "admin@sistema.inova.br",
  role: "Desenvolvedor", // 'Desenvolvedor' ou 'Administrador'
  avatar: "👨‍💼",
};
 ...
 * - value: valor atual
 * - icon: qual ícone mostrar (nome do ícone do Lucide)
 * - trend: tendência (ex: "+2")
 * - trendUp: se está subindo (true) ou descendo (false)
 */
...
/**
 * Feedbacks (Sugestões e Denúncias)
 *
 * Lista de sugestões dos usuários
 * Usado no Dashboard para mostrar feedback recente
 */
 ...
 * Usado na página /usuarios para listar todos os usuários
 *
 * Cada usuário tem:
 * - id: identificador único
 * - name: nome completo
 * - email: email do usuário
 * - avatar: emoji para representar visualmente
 * - type: tipo (Motorista, Passageiro, Ambos, Admin, etc)
 * - status: Ativo, Inativo, Suspenso, Pendente, etc
 * - lastAccess: última vez que entrou
 * - ipLogin: último IP
 * - school: instituição
 * - course: curso
 */
...
export const suggestionsData = [
  {
    ...
    status: "Resolvido",
    response:
      "Obrigado pela sugestão! Já está no nosso backlog para a próxima sprint.",
  },
  {
    id: 2,
    userName: "Lucas Pereira",
  ...
  },
  {
    ...
    status: "Resolvido",
    response:
      "Denúncia verificada e confirmada. O usuário foi suspenso. Obrigado pelo aviso.",
  },
];
...
export const reportsData = [
  {
    ...
    description:
      "Análise detalhada de cadastros, atividades e perfis de estudantes.",
    icon: "Users",
  },
  {
    id: 2,
    ...
    description:
      "Estatísticas de viagens realizadas, canceladas e em andamento.",
    icon: "Car",
  },
  {
    id: 3,
    ...
    description:
      "Acompanhamento de sugestões e denúncias enviadas pelos usuários.",
    icon: "AlertCircle",
  },
  {
    id: 4,
...
export const contractsData = [
  {
    ...
    status: "Ativo",
    description:
      "Contrato de uso da plataforma CaronaCity para estudantes e funcionários",
  ...
  },
  {
    ...
    status: "Vencido",
    description:
      "Termo de responsabilidade e segurança para uso da plataforma de caronas",
  ...
  },
  {
    ...
    status: "Ativo",
    description:
      "Conformidade com LGPD e políticas de proteção de dados dos usuários",
  ...
  },
  {
    ...
    description:
      "Contrato em revisão para assinatura dos representantes da instituição",
...
export const apiRidesData = [
  ...
  },
  {
    ...
    passageiros: [{ usu_id: 1, usu_nome: "Carlos Silva" }],
  },
  {
    car_id: 4,
    usu_id_motorista: 1,
    ...
    vei_placa: "ABC-1234",
    vei_modelo: "Toyota Corolla",
    passageiros: [{ usu_id: 5, usu_nome: "Lucas Pereira" }],
  },
  {
    car_id: 5,
    usu_id_motorista: 1,
...
export const apiSuggestionsData = [
  {
    ...
    usu_nome: "Mariana Souza",
    sug_texto:
      "Seria ótimo ter um filtro de caronas por horário de saída mais específico.",
    sug_tipo: 0,
    sug_status: 1,
    sug_resposta:
      "Obrigado pela sugestão! Já está no nosso backlog para a próxima sprint.",
  ...
  },
  {
    ...
    usu_nome: "Lucas Pereira",
    sug_texto:
      "O usuário Carlos Silva cancelou a carona em cima da hora sem nenhum aviso.",
    sug_tipo: 1,
    sug_status: 2,
    sug_resposta: null,
    sug_carona_id: 4,
  ...
  },
  {
    ...
    usu_nome: "Carlos Silva",
    sug_texto:
      "Poderia ter uma opção de carona recorrente para quem vai ao mesmo lugar todo dia.",
    sug_tipo: 0,
    sug_status: 0,
    sug_resposta: null,
  ...
  },
  {
    ...
    usu_nome: "Pedro Santos",
    sug_texto:
      "Encontrei um usuário com comprovante de matrícula claramente falsificado.",
    sug_tipo: 1,
    sug_status: 1,
    sug_resposta:
      "Denúncia verificada e confirmada. O usuário foi suspenso. Obrigado pelo aviso.",
